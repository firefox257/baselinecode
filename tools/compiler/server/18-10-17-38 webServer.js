...
In the allowHead in the OPTIONS
Add in headers LS, READFILE,SAVEFILE.
LS is to list out the file information eather itnis a file or list the files in the directory.
Make sure to include the modified date in milliseconds from the epich style.
LS functions like ls in linux make sure to include wildcards as well.
It should return an JSON array with a list of objects. 
OPENFILE reads the file as a text file.
SAVEFILE will save the file with the given directory.

Do not use use query uri. add additional headers.
Change the code to implement LS, READFILE, SAVEFILE
...
class WebServer {
    #allowHead = {
        ...
        'Access-Control-Allow-Methods':
            'OPTIONS, POST, GET, PUT, PATCH, DELETE, LS, READFILE, SAVEFILE',
