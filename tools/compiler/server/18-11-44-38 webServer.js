...
Change the ls from an array to object. include the file size in the info.
...
class WebServer {
    #allowHead = {
        ...
        'Access-Control-Allow-Headers':
            'Origin, X-Requested-With, Content-Type, Accept, Authorization, LS, READFILE, SAVEFILE' // Added LS, READFILE, SAVEFILE
    }
    ...
    handelweb(req, res) {
        try {
            ...
            // Custom API handling for LS, READFILE, SAVEFILE
