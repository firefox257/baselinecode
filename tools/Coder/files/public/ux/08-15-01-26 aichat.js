...
class AIChat extends HTMLElement {
    constructor() {
        ...
        this.messages = []; // New: Array to store conversation history
    ...
    async connectedCallback() {
        ...
        // Load system prompt from localStorage (this persists across restarts as desired)
        const cachedSystemPrompt = localStorage.getItem(LOCAL_STORAGE_SYSTEM_PROMPT_KEY);
        if (cachedSystemPrompt) {
            this.systemPrompt = cachedSystemPrompt;
        }
        ...
        // Set the system input content after loading from cache or default
    ...
    setupEventListeners() {
        ...
        if (systemInput) {
            systemInput.addEventListener('input', (event) => {
                ...
                // No need to save messages to localStorage here if we clear on load.
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .chat-area p { /* Style for chat messages */
                    ...
                    white-space: pre; /* Preserve whitespace and newlines, but NO automatic line wrapping */
